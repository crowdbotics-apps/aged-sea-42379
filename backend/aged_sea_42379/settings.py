"""
Django settings for aged_sea_42379 project.
...
ROOT_URLCONF = 'aged_sea_42379.urls'
...
WSGI_APPLICATION = 'aged_sea_42379.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_sea_42379 API",
    "DESCRIPTION": "API documentation for aged_sea_42379 App",
    "VERSION": "v1",
}
